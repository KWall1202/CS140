...
public class River extends BodyOfWater {
    ...
    /**
    * This method returns the name of the final body of water that can be reached from
    * this river.
    * @return name of final body of
    * water that can be reached from this river.
    */
    public String flowsOutTo() {
        if(flowsInto instanceof River) {
            return ((River)flowsInto).flowsOutTo();
        } else {
            return getFlowsInto().getName();
        }
    }
}
