...
public class BankTester {
    ...
    public void initialize(){
        ...
        accounts.add(new SavingsAccount(1, .65));
    ...
    @Test
    public void testCheckingAccWithdrawTooMany() {
    	CheckingAccount checking = new CheckingAccount(50, 10);
    	for( int i=0; i < 13; i++) {
    		checking.withdraw(1);
    	}
    	try {
    		assertEquals(0, checking.withdraw(35), 1e-6);
    	} catch(AssertionError e) {
    ...
    @Test
    public void testBankAccSmallWithdraw() {
        BankAccount bacc = new BankAccount(700.00);
        try {
        	assertEquals(50, bacc.withdraw(50), 1e-6);
        } catch(AssertionError e) {
    ...
    @Test
    public void testBankAccBigWithdraw() {
    	BankAccount bacc = new BankAccount(85.0);
    	try {
    		assertEquals(85, bacc.withdraw(300), 1e-6);
    	} catch(AssertionError e) {
    		System.out.println("BankAccount's withdraw() method failed: " + e.getMessage());
    		throw e;
    	}
    ...
    public void testSavingsAccountDeposit() {
    	...
    	try {
    		savings.deposit(50);
    		assertEquals(4050 + 50*0.15, savings.getBalance(), 1e-6);
    	} catch(AssertionError e) {
    ...
    public void testAccountsDeposit() {
        ...
        for(BankAccount i: accounts) {
            ...
            if (i.getIdNum() == 4) {
            	addition = amount * 0.1;
            } else if (i.getIdNum() == 5) {
            	addition = amount * 0.65;
            }
            try {
