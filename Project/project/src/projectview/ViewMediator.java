...
//				System.out.println("Exception message: " + e.getMessage());			
				...
				JOptionPane.showMessageDialog(frame, 
						"Illegal access to array index from line " + model.getPC() + "\n"
								+ "Exception message: " + e.getMessage(),
								"Run time error",
								JOptionPane.OK_OPTION);
//					System.out.println("Illegal access to array index from line " + model.getPC()); // just for debugging
//					System.out.println("Exception message: " + e.getMessage());	
...
//					System.out.println("Exception message: " + e.getMessage());	
				...
				JOptionPane.showMessageDialog(frame, 
						"Attempt to divide by zero from line " + model.getPC() + "\n"
								+ "Exception message: " + e.getMessage(),
								"Run time error",
								JOptionPane.OK_OPTION);
//					System.out.println("Attempt to divide by zero from line " + model.getPC()); // just for debugging
//					System.out.println("Exception message: " + e.getMessage());	
			}
			setChanged();
			notifyObservers();
